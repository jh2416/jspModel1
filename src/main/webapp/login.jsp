...
<form action="loginAf.jsp" method="post">	<!-- 로그인이니까 post -->
...
$("#chk_save_id").click(function () {
	...
	if( $("#chk_save_id").is(":checked") == true ){
		...
		if( $("#id").val().trim() == "" ){	//id가 빈칸이면 trim은 띄어쓰기 제거
			alert('id를 입력해 주십시오');
			$("#chk_save_id").prop("checked", false);	//체크박스 꺼주기
		}else{
			// cookie를 저장
			$.cookie("user_id", $("#id").val().trim(), { expires:7, path:'./' }); //맨뒤는 기한, 요즘은 잘안함, 7일, 모든경로
		}
